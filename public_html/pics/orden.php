							...
							if($dataDetcom->unitPrice == 0 AND   $dataDetcom->totalPrice == 0)
								{
									...
									<tr>
										...
										<td "><input type="checkbox"  value="'. $dataDetcom->description . '" name="checkbox'.$i. '"/></td>
								...
								else
								{
									...
									<tr>
										<td align="center" HEIGHT="100">' . $dataDetcom->quantity . '</td>
										<td align="center"><input type="checkbox"  value="'. $dataDetcom->description . '" name="checkbox'.$i. '">  '. $dataDetcom->description . '</input></td>
